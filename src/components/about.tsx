        ...
        <div className="grid items-center gap-12 md:grid-cols-2 lg:gap-16">
          ...
          <div className="space-y-8 animate-fade-in">
            ...
            <div className="space-y-4 text-lg leading-relaxed text-muted-foreground">
              <p>
                Estoy formándome como desarrollador a través de proyectos propios,
                creando y mejorando con cada versión.
              </p>

              <p>
                Ahora busco dar el siguiente paso y ganar experiencia en una empresa
